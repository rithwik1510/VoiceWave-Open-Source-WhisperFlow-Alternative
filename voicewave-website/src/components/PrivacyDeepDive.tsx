    ...
    <div className="relative w-full overflow-hidden rounded-2xl border border-[#1e3557] bg-[#080f1e] p-4">
      ...
      <svg viewBox="0 0 300 100" className="w-full" aria-hidden="true">
        ...
        <rect x="248" y="40" width="34" height="20" rx="5" fill="#0a1528"
          stroke={textActive ? '#7ed8ff' : '#1c3356'} strokeWidth={textActive ? 1.8 : 1.2}
          style={{ transition: 'stroke 400ms ease' }}
        />
        <line x1="253" y1="47" x2="278" y2="47" stroke={textActive ? '#7ed8ff' : '#1c3356'} strokeWidth="1.5" strokeLinecap="round" style={{ transition: 'stroke 300ms ease' }} />
        <line x1="253" y1="53" x2="271" y2="53" stroke={textActive ? '#5cb8e8' : '#1c3356'} strokeWidth="1.5" strokeLinecap="round" style={{ transition: 'stroke 300ms 100ms ease' }} />
        ...
        {phase === 'inserted' && (
          <line x1="162" y1="50" x2="248" y2="50" stroke="#7ed8ff" strokeWidth="2" strokeLinecap="round" strokeOpacity="0.8" />
        )}
...
export default function PrivacyDeepDive() {
  ...
  return (
    <section ref={sectionRef} id="privacy" className="section-pad relative scroll-mt-28 bg-transparent text-[#09090B] lg:min-h-[175vh]">
      ...
      <div className="site-shell px-0 grid grid-cols-1 lg:grid-cols-12 gap-10 md:gap-14 relative z-10">
        <div className="lg:col-span-5 relative">
          <div className="lg:sticky top-32">
            <div className="section-title-row mb-8">
              ...
              <span className="font-mono text-sm uppercase tracking-widest font-bold text-[#4b5e76]">Under the hood</span>
            </div>
            <motion.h2
            ...
            >
              Private <br />
              <span className="text-[#5b7392]">by architecture.</span>
            </motion.h2>
            <motion.p
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              Not a privacy policy — an architecture. There is no cloud transcription
              path in the codebase, so your audio can&apos;t leave even by accident.
            </motion.p>
            ...
            >
              <div className="bg-[#FFFFFF]/92 border border-[#d7e5f7] p-4 vw-radius-tab shadow-sm max-w-xs">
                <span className="block font-mono text-xs text-[#64748B] uppercase mb-1">The only network calls</span>
                <span className="block font-bold text-sm">Model downloads &amp; signed update checks — both from GitHub, both visible in the source.</span>
              </div>
            </motion.div>
          </div>
        </div>
        ...
        <div className="lg:col-span-7 flex flex-col gap-10 sm:gap-14 mt-8 lg:mt-0 relative pb-6 sm:pb-10">
          ...
          >
            ...
            <h3 className="font-display text-3xl sm:text-4xl font-bold text-[#09090B] mb-4">One Tight Loop</h3>
            <p className="text-base sm:text-lg text-[#475569] font-medium leading-relaxed max-w-sm mb-8">
              Capture, decode, and insertion run as one on-device pipeline — release the
              key and text lands in about a second on typical hardware.
            </p>
          ...
          >
            ...
            <h3 className="font-display text-3xl sm:text-4xl font-bold text-[#09090B] mb-4">Your Hardware, Your Model</h3>
            <p className="text-base sm:text-lg text-[#475569] font-medium leading-relaxed max-w-sm mb-8">
              Ships with a fast default model that runs on any modern CPU. Want more
              accuracy? Install larger Whisper models with checksum verification.
            </p>
          ...
          >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="mt-6 inline-flex items-center gap-2 rounded-full border border-[#28457f] bg-[#101c32] px-4 py-2 font-mono text-[11px] font-bold uppercase tracking-[0.14em] text-[#bcd6ff] transition-colors hover:border-[#3f8dff] hover:text-white"
            >
