...
const ONYX_PALETTE = {
  ...
  sidebarBg: "bg-shell",
  surface: "bg-surface",
  surfaceHighlight: "bg-inset",
  border: "border-edge",
  textPrimary: "text-ink-strong",
  textSecondary: "text-sub",
  textTertiary: "text-hint",
  accent: "vw-brand-accent",
  accentFg: "text-on-accent",
  success: "text-ink",
  warning: "text-quiet",
  error: "text-status-danger-text",
  recording: "bg-recording-fill",
  navActiveBg: "bg-surface",
  navActiveFg: "text-ink",
  shellBg: "bg-shell",
  canvasBg: "bg-canvas",
  canvasBorder: "border-transparent",
  surfaceBorder: "border-edge",
  divider: "border-edge-strong",
  accentBlue: "#1B8EFF",
  accentCyan: "#7ED8FF",
